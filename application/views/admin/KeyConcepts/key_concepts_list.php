<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Admin_controller/getKeyConceptData') ?>',
            ...
            "aoColumns": [{'mRender': checkbox, "bSortable": false}, {"mRender": null},{"mRender": null},{"bSortable": false}],
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="border-radius: 0px;padding: 0px">
                                    ...
                                    <span class="pull-right btn-group">
                                        <a href="<?php print base_url(); ?>admin/KeyConcepts-add"><button type="button"  title="Add Key Concept" class="btn btn-success"><i class="fa fa-plus-circle"></i></button></a>
                                    ...
                                    <table id="getData" class="dataTable table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-xs-2" style="width:80px;min-width:30px;">Subject Name</th>
                                                <th class="col-xs-2" style="width:80px;min-width:30px;text-align: center;">Topic Name</th>
