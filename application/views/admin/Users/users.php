<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/System_user_controller/getSysUsersData') ?>',
            ...
            "aoColumns": [{'mRender': checkbox, "bSortable": false}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": setUStatus}, {"bSortable": false}],
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                $('td:eq(6) > label', nRow).attr('onclick', "changeUStatus('id'," + aData[0] + ",'system_users')");
            },
                ...
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form id="xform" onsubmit="return bulkDelete()">
                            ...
                            <input type="hidden" name="tab" value="system_users"/>
                            <div class="panel panel-default">
                                <div class="panel-heading" style="border-radius: 0px;padding: 0px">
                                    ...
                                    <span class="pull-right btn-group">
                                        <a href="<?php print base_url(); ?>admin/Users-add"><button type="button"  title="Add User" class="btn btn-success"><i class="fa fa-plus-circle"></i></button></a>
                                        <button type="button" class="btn btn-default" onclick="oTable.fnDraw();" title="Refresh"><i class="fa fa-refresh"></i></button>
                                        <button type="submit" class="btn btn-danger" title="Delete User"><i class="fa fa-trash-o"></i></button>
                                    </span>
