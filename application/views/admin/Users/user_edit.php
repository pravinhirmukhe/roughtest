                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" id="first_name" class="form-control" value="<?=  setValue(set_value('first_name'), $user->first_name); ?>"oninput="validateAlpha();"  placeholder="First Name"/>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_name" id="last_name" class="form-control" value="<?=  setValue(set_value('last_name'), $user->last_name); ?>" oninput="validateAlpha();"  placeholder="Last Name" />
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label>Company</label>
                                            <input type="text" name="company" id="company" class="form-control" value="<?=  setValue(set_value('company'), $user->company); ?>" placeholder="Company" />
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="repassword" id="repassword" class="form-control" value="<?=  setValue(set_value('repassword'), $user->password); ?>" placeholder="Re Type Password" />
                                 ...
                                 <div class="row recruiter" style="display:none">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label>Website</label>
                                            <input type="text" name="website" id="website" class="form-control"  value="<?=  setValue(set_value('website'), $user->website); ?>" placeholder="Website" />
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_dropdown('location', array(''=>"Select",'pune' => "pune", 'mumbai' => "Mumbai"), set_value(set_value('location'), $user->location), 'class="form-control" id="location" placeholder="Location"'); ?>
                                ...
                                <div class="row recruiter" style="display:none">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_dropdown('no_of_employee', array(''=>"Select",'upto_10' => "Up to 10", '11-100' => "11 - 100",'101-1000'=>"101 - 1000",'1000+'=>"1000+"), set_value(set_value('no_of_employee'), $user->no_of_employee), 'class="form-control" placeholder="no_of_employee"'); ?>
                                     ...
                                     <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="company_desc" name="company_desc" class="form-control" placeholder="Company Description" value="<?php echo $user->company_desc; ?>"><?php echo $user->company_desc; ?></textarea>
                                ...
                                <div class="row recruiter" style="display:none">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label>FB Link</label>
                                            <input type="text" name="fb_link" id="fb_link" class="form-control" value="<?=  setValue(set_value('fb_link'), $user->fb_link); ?>" placeholder="FB Link" />
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="linkedin_link" id="linkedin_link" class="form-control" value="<?=  setValue(set_value('linkedin_link'), $user->linkedin_link); ?>" placeholder="Linkedin Link" />
                                ...
                                <div class="row recruiter" style="display:none">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="com_fb_link" id="com_fb_link" class="form-control" value="<?=  setValue(set_value('com_fb_link'), $user->com_fb_link); ?>" placeholder="FB Link" />
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="com_linkedin_link" id="com_linkedin_link" class="form-control" value="<?=  setValue(set_value('com_linkedin_link'), $user->com_linkedin_link); ?>" placeholder="Linkedin Link" />
