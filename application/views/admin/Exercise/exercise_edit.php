            ...
            <div class="col-md-12">
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form action="<?= site_url() ?>admin/Exercise-update/<?= $id ?>" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('topic_id', $gr, set_value(set_value('topic_id'), $exercise->topic_id), 'id="topic_id" class="form-control" placeholder="Select Topic"');
                                            ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('q_type', $qt, set_value(set_value('id'), $exercise->q_type), 'id="q_type" class="form-control" placeholder="Select Question Type"');
                                            ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label>Answer</label>
                                            <?php echo form_dropdown('Answer', array('1' => "Option 1", '2' => "Option 2",'3'=>"Option 3",'4'=>"Option 4"), setValue(set_value('Answer'), $exercise->Answer), 'class="form-control" id="Answer" placeholder="Answer"'); ?>
                             ...
                             <div class="row">
                                <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_dropdown('Difficulty_level', array('Easy' => "Easy", 'Medium' => "Medium",'Hard'=>"Hard"), set_value(set_value(set_value('Difficulty_level'), $exercise->Difficulty_level), $exercise->Difficulty_level), 'class="form-control" id="Difficulty_level" placeholder="Difficulty_level"'); ?>
