            ...
            <div class="col-md-12">
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form action="<?= site_url() ?>admin/Menus-save" method="POST">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label>Url</label>
                                            <input type="text" name="url" id="cname" class="form-control" value="<?php echo set_value('url'); ?>" oninput="validateAlpha();"  placeholder="Menu Url" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Icon</label>
                                            <input type="text" name="icon" id="cname" class="form-control" value="<?php echo set_value('icon'); ?>" placeholder="Icon" />
