...
?>
    ...
    AmCharts.ready(function () {
        ...
        durationAxis.title = "Percentile (Cumulative)";
        ...
        durationGraph.id = "g2";
        durationGraph.title = "Percentile(Cumulative)";
        durationGraph.valueField = "duration";
        durationGraph.type = "line";
        durationGraph.valueAxis = durationAxis; // indicate which axis should be used
        durationGraph.lineColor = "#ff5755";
        durationGraph.balloonText = "Percentile(Cumulative):[[value]]";
        durationGraph.lineThickness = 1;
        durationGraph.legendValueText = "Percentile(Cumulative):[[value]]";
