<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/System_user_controller/getMenusData') ?>',
            ...
            "aoColumns": [{'mRender': checkbox, "bSortable": false}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": setStatus}, {"bSortable": false}],
                        ...
                        <form id="xform" onsubmit="return bulkDelete()">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="border-radius: 0px;padding: 0px">
                                    <h3 class="panel-title pull-left" style="padding: 8px">System Users <small>Vendor user for System</small></h3>
