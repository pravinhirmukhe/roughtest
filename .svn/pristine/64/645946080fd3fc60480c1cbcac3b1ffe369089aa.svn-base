                    ...
                    <div class="table-responsive">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="border-radius: 0px;padding: 0px">
                                <h3 class="panel-title pull-left" style="padding: 8px">System Users Menu Allocation <small>Menu Allocation</small></h3>
                                <div class="clearfix"></div>
                            </div>
                            <?php
                            $x = array();
                            if (isset($user->menu_ids)) {
                                $x = json_decode($user->menu_ids, true);
                            }
                            ?>
                            <form action="<?= site_url() ?>admin/User-menu-alloc-save/<?= $id ?>" method="POST">
