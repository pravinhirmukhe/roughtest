...
$month = date("m");
$year = date("Y");
$c = $this->db->order_by('id', 'desc')->limit($graph_limit)->get('rs_weekly_marks');
...
//            for($i=1;$i<=$c;$i++){
    foreach ($wr_q->result_array() as $wr_d) {
        ...
        $date = $year . "-" . $month . "-" . $i;
        $rank_arr = json_decode($wr_d['cumulative_marks']);
...
?>
    ...
    AmCharts.ready(function () {
        ...
        durationGraph.id = "g2";
        durationGraph.title = "Cumulative";
        durationGraph.valueField = "duration";
        durationGraph.type = "line";
        durationGraph.valueAxis = durationAxis; // indicate which axis should be used
        durationGraph.lineColor = "#ff5755";
        durationGraph.balloonText = "Cumulative:[[value]]";
        durationGraph.lineThickness = 1;
        durationGraph.legendValueText = "Cumulative:[[value]]";
