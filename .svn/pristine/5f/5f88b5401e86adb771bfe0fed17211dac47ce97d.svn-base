<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/System_user_controller/getGroupsData') ?>',
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="border-radius: 0px;padding: 0px">
                                    ...
                                    <span class="pull-right btn-group">
                                        <a href="<?php print base_url(); ?>admin/Groups-add"><button type="button"  title="Add User" class="btn btn-success"><i class="fa fa-plus-circle"></i></button></a>
                                        <button type="button" class="btn btn-default" onclick="oTable.fnDraw();" title="Refresh"><i class="fa fa-refresh"></i></button>
                                        <button type="submit" class="btn btn-danger" title="Delete User Group"><i class="fa fa-trash-o"></i></button>
                                    </span>
                                    ...
                                    <table id="getData" class="dataTable table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-xs-2" style="width:80px;min-width:30px;">Name</th>
                                                <th class="col-xs-2" style="width:80px;min-width:30px;text-align: center;">Description</th>
